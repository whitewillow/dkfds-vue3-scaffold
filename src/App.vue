      ...
      <div class="navbar navbar-primary">
        <div class="navbar-inner container">
          <ul class="nav-primary">
            ...
            <li role="none" :class="[{ current: isPartOfMenu('eksempel') }]">
              <fds-nav-link @click="router.push({ name: 'eksempel' })" title="Link title">
                Eksempel
              </fds-nav-link>
            </li>
            <li role="none" :class="[{ current: isPartOfMenu('om') }]">
              <fds-nav-link @click="router.push({ name: 'om' })" title="Link title">
                Om
              </fds-nav-link>
            </li>
          </ul>
